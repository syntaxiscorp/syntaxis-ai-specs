...
## Historia
Como **usuario del Tree-Table de Actividades**, quiero **ver el badge de estado de restricción renderizado directamente en las filas de los nodos hoja**, para **identificar visualmente qué actividades tienen restricciones activas sin salir de la tabla**.
